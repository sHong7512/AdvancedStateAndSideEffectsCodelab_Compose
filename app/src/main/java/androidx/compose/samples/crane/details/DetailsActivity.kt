...
//    }
    ...
    /*
    내부적으로 produceState는 다른 효과를 사용합니다.
    remember { mutableStateOf(initialValue) }를 사용하는 result 변수를 보유하며 LaunchedEffect에서 producer 블록을 트리거합니다.
    producer 블록에서 value가 업데이트될 때마다 result 상태가 새 값으로 업데이트됩니다.
     */
